 ...
 * @license MIT
 * @version 2.0.0
 */class c{constructor({data:e,config:t,api:r,readOnly:s}){this.api=r,this.readOnly=s,this._settings=t,this._data=this.normalizeData(e),this._element=this.getTag()}get _CSS(){return{block:this.api.styles.block,wrapper:"ce-header"}}
/**
